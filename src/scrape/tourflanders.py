...
enddir = 'D:\\development\\tourflanders\\'
...
url_list = []
url_file = 'https://raw.githubusercontent.com/kim3-sudo/cycling_analysis/main/data/tourflanders.txt'
header = {
  "User-Agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.75 Safari/537.36",
  "X-Requested-With": "XMLHttpRequest"
}
...
for index, url in enumerate(url_list):
    ...
    try:
        ...
        df = pd.DataFrame(data, columns = ['rank','bib','rider','age','team', 'uci', 'point','time'])
        df['stage'] = stageList
        df['year'] = yearList
        df = df.iloc[1:]
